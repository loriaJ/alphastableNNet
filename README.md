...
To obtain the Table 1 of the paper, you can simply run the script `./york_air_quality/compare_validation_results.R`. To obtain the results used for that table you can run the `./york_air_quality/samps_valid_tubes.R`, which uses output (i.e., q_ell and Lambda) from the file `./york_air_quality/splits_valid_tubes.R`.
